...
clean_files = find_files(os.path.join('./../LibriSpeech'), pattern='**/*.flac')
...
noise_files = find_files('./../../../Audio_augmentation/Official_Noise/AURORA')
snr_ = [-10, -5, 0]
# 16 kHz
sr = 16000
